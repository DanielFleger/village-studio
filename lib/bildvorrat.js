...
//
// tile_sea8 ist Wasser: 868 Einzelkacheln und 12 Vierer. Es steht hier, weil
// der Wassergraben daraus gemalt wird - nicht, weil es Gebaeude waeren.
...
const DATEIEN = ['tile_buildings1', 'tile_buildings2', 'tile_workshops', 'tile_castle', 'tile_churches',
  ...
  // schon zugeordneten Bilder verrutscht. Darin liegt das tuerkise Wasser des
  // Wassergrabens; in den zehn Dateien darueber gibt es kein einziges
  // blaugruenes 1x1-Bild.
  'tile_sea8'];
