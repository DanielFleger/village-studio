...
| Wie die Teile eines Gebäudes zueinander liegen | **offen** | **Meine erste Lesart ist widerlegt.** Gemessen an der Kapelle (36 Teile): Die Teile stehen im Abstand 16 waagerecht und 8 senkrecht, und die senkrechte Spanne ist **192** Punkte — für ein 6×6-Grundstück wären höchstens 96 möglich. Die 36 Teile sind also nicht die 36 Kacheln einer Grundfläche. Nur 11 der 36 tragen überhaupt einen Aufbau; die Übrigen sind 512 Byte, also blosse Kacheln. Im zusammengesetzten Bild schwebt der Bau deshalb über seinem Boden |
| Dass `teile` trotzdem die Grundfläche nennt | **gemessen, nicht bewiesen** | Die Übereinstimmung 36/81/169 mit Kapelle 6×6, Kirche 9×9, Kathedrale 13×13 ist stark, stützt sich aber auf drei Fälle und auf die Namen der Datei. Als Filter für die Zuordnung taugt sie; als Bauanleitung nicht |
